...
public class MainActivity extends AppCompatActivity {
    ...
    private Stack<LetterTile> StackedTiles;
    ...
    public boolean onStartGame(View view) {
        ...
        word1=words.get(random.nextInt(bound));
        word2=words.get(random.nextInt(bound));
        String word3 = "";
        int word1Count = 0;
        int word2Count = 0;
    ...
    public boolean onUndo(View view) {
        ...
        if (StackedTiles.empty()) {
            ...
            LetterTile tile = StackedTiles.pop();
